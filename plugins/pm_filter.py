...
<b>📜 Quote :</b> <code>That which does not kill us makes us stronger ...</code>""".format(query.from_user.mention), reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
